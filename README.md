...
![Continuous Integration](https://github.com/koromerzhin/template-vuejs/workflows/Continuous%20Integration/badge.svg?branch=develop)<!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
...
Feel free to check [issues page](https://github.com/koromerzhin/template-vuejs/issues).
You can also take a look at the [contributing guide](
    https://github.com/koromerzhin/template-vuejs/blob/develop/CONTRIBUTING.md
    ).
...
This project is [MIT](
    https://github.com/koromerzhin/template-vuejs/blob/develop/LICENSE
    ) licensed.
...
<table>
  <tr>
    ...
    <td align="center"><a href="https://github.com/apps/dependabot-preview"><img src="https://avatars3.githubusercontent.com/in/2141?v=4" width="100px;" alt=""/><br /><sub><b>dependabot-preview[bot]</b></sub></a></td>
